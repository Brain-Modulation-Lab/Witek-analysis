...
% $Revision: 1.11 $ $Date: 2002/05/17 14:17:56 $
...
mAnalysis = uimenu('parent',hfig,'label','&Analysis');
uimenu('parent',mAnalysis, ...
   'Label','Spectrogram Presentation', ...
   'Callback',@finalGUItest);
