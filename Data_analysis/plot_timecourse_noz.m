function [STATStimecourse1, STATStimecourse2, h] = plot_timecourse_noz( timecourse1, timecourse2, fq, field, time_range, fq_range)
...
for i=1:10
    ...
    imagesc((1:1001)/1000-0.5, fq, timecourse1(i).(field)'); set(gca,'YDir','normal'); set(gca,'FontSize',5); hold on; plot([0 0], ylim, ':', 'Color', 'w');
    ...
    imagesc((1:1001)/1000-0.5, fq, timecourse2(i).(field)'); set(gca,'YDir','normal'); set(gca,'FontSize',5); hold on; plot([0 0], ylim, ':', 'Color', 'w');
    hold on; plot(time_range(1)*[1 1], fq_range, 'Color', 'w', 'LineWidth', 2);
    hold on; plot(time_range(2)*[1 1], fq_range, 'Color', 'w', 'LineWidth', 2);
    hold on; plot(time_range, fq_range(1)*[1 1], 'Color', 'w', 'LineWidth', 2);
    hold on; plot(time_range, fq_range(2)*[1 1], 'Color', 'w', 'LineWidth', 2);
