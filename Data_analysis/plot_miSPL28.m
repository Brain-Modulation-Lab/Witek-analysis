function [ h ] = plot_miSPL28( LFP_SPL, fs, fq, name, FontSize, time_range, fq_range, prespike, postspike)
...
for i=1:Ncontacts
    ...
    h1(i)=subplot(2,Ncontacts/2,i);
    imagesc((1:(prespike+postspike+1))/fs-(prespike+postspike)/(2*fs), fq, LFP_SPL(i).zmi'); set(gca,'FontSize',FontSize); set(gca,'YDir','normal'); hold on; plot([0 0], ylim, ':', 'Color', 'w'); title(num2str(i));
